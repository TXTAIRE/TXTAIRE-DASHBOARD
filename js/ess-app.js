...
function showEssBirthdayCelebration(emp) {
  ...
  // any prior gesture. Deliberately no visible play-button fallback here (explicit product
  // decision) -- a device that blocks it just gets a silent popup, with no way to recover
  // sound short of the employee's own browser settings.
