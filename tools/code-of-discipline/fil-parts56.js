...
const part5 = () => [
  ...
  bullet('Magpapanatili ang kompanya ng first aid at magkakaroon ng sanay na first-aider, safety officer, at health and safety committee ayon sa bilang ng tauhan. Nasa Annex F kung paano nagbabago ang mga kailangang ito habang lumalaki ang kompanya.'),
  ...
  bullet([B('Walang on-the-spot na pag-test. '), run('Sa dating edisyon, puwedeng mag-test ang kompanya batay sa hinala at pilitin ang pagbibigay ng sample sa mismong sandali. Hindi ito pinapayagan. Kung may makatuwirang dahilan ang kompanyang maniwalang lasing sa droga ang isang empleyado sa trabaho, aalisin muna siya sa anumang gawaing kritikal sa kaligtasan, at ipapadala ang usapin para sa pag-test sa akreditadong laboratoryo sa ilalim ng mga proteksyong nasa itaas.')]),
