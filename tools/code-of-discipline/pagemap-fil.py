...
doc = pymupdf.open(os.path.join(b, "out-fil.pdf"))
...
TARGETS = [
    ("soc",  "sec",  "Buod ng mga Pagbabago"),
    ("socA", "sub",  "A.  Mga parusang pinagaan"),
    ("socB", "sub",  "B.  Mga probisyong inalis"),
    ("socC", "sub",  "C.  Ano ang bago sa edisyong ito"),
    ("socD", "sub",  "D.  Mga benepisyong isinunod"),
...
json.dump(out, open(os.path.join(b, "pagemap-fil.json"), "w"), indent=1)
