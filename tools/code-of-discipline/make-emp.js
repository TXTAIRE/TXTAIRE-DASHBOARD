...
L.setAudience('employee');   // must run before any content module is required
...
const OUT = process.argv[2] || path.join(__dirname, 'out-emp.docx');
...
const footer = new d.Footer({
  children: [
    new d.Paragraph({
      ...
      children: [
        new d.TextRun({ text: 'TXTAIRE OPC  |  Code of Discipline  |  Series 2, 2026  |  Employee Copy', font: 'Arial', size: 15, color: '7A7A7A' }),
