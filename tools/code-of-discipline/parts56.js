...
const part5 = () => [
  ...
  bullet('The Company shall maintain first aid facilities and shall have trained first-aiders, safety officers and a health and safety committee as required for its headcount. Annex F sets out how these requirements change as the Company grows.'),
  ...
  bullet([B('No on-the-spot testing. '), run('The previous edition allowed the Company to conduct on-the-spot testing and to compel the giving of urine or blood samples on suspicion alone. That is not permitted. Where the Company has reasonable ground to believe an employee is under the influence at work, it shall remove the employee from any safety-critical task, and refer the matter for testing through the accredited laboratory under the safeguards above.')]),
...
const part6 = () => [
  ...
  note('The two-month liquidated damages clause is withdrawn', [
